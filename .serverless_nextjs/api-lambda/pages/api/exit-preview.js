...
/* harmony export */ });
/* harmony import */ var _prismicio_next__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9928);

async function exit(req, res) {
    await (0,_prismicio_next__WEBPACK_IMPORTED_MODULE_0__/* .exitPreview */ ._H)({
        res,
        req
    });
};
...
var __webpack_exports__ = __webpack_require__.X(0, [458,928,800], () => (__webpack_exec__(37849)));
